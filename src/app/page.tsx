    ...
    <div className="h-screen paper-texture p-4 md:p-8 flex flex-col">
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full overflow-y-auto">
        <div
              ...
              <div className="flex flex-col items-center w-full max-w-2xl mb-8 mx-auto">
                <div className="flex flex-col sm:flex-row items-center mb-6 gap-4">
                  ...
                  <div className="text-center sm:text-left">
                    ...
                    <p className="text-[var(--accent-primary)] text-sm max-w-md">Browse previously generated wikis</p>
                  </div>
                </div>
              </div>
            ...
            <>
              ...
              <div className="flex flex-col items-center w-full max-w-2xl mb-8">
                <div className="flex flex-col sm:flex-row items-center mb-6 gap-4">
                  ...
                  <div className="text-center sm:text-left">
                    <h2 className="text-2xl font-bold text-[var(--foreground)] font-serif mb-1">Welcome to DeepWiki</h2>
                    <p className="text-[var(--accent-primary)] text-sm max-w-md">Generate comprehensive wikis from your repositories</p>
                  </div>
                </div>

                <p className="text-[var(--foreground)] text-center mb-8 text-lg leading-relaxed">
                  Transform your repositories into comprehensive, AI-generated wikis with intelligent documentation, visual diagrams, and deep code analysis.
                </p>
              </div>
          ...
          <div
            ...
            <p className="text-sm text-[var(--foreground)] mb-3">Enter your repository URL to get started</p>
          ...
          <div
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-4">
              ...
              <h3 className="text-base font-semibold text-[var(--foreground)] font-serif">Advanced Visualization</h3>
            </div>
            <p className="text-sm text-[var(--foreground)] mb-5 leading-relaxed">
              Automatically generate interactive diagrams and flowcharts to visualize your project architecture.
            </p>
      ...
      <footer className="max-w-6xl mx-auto mt-8 flex flex-col gap-4 w-full">
        <div
          ...
          <p className="text-[var(--muted)] text-sm font-serif">DeepWiki - Generate Wiki from GitHub/Gitlab/Bitbucket repositories</p>
